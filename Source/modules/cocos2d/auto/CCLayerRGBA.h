...
#ifndef __CCLayerRGBA_h__
#define __CCLayerRGBA_h__
...
public:
    void trace(Visitor*) {}
    static PassRefPtrWillBeRawPtr<CCLayerRGBA> create();
    ...
    cocos2d::CCLayerRGBA* getCocos2dImpl();
    ~CCLayerRGBA();
public:
    CCLayerRGBA ();
};

DEFINE_TYPE_CASTS(CCLayerRGBA, CCLayer, pCCLayerRGBA, true, true);
