...
#ifndef __CCParticleSpiral_h__
#define __CCParticleSpiral_h__
...
public:
    void trace(Visitor*) {}
    static PassRefPtrWillBeRawPtr<CCParticleSpiral> create();
    ...
    cocos2d::CCParticleSpiral* getCocos2dImpl();
    ~CCParticleSpiral();
public:
    CCParticleSpiral ();
};

DEFINE_TYPE_CASTS(CCParticleSpiral, CCParticleSystemQuad, pCCParticleSpiral, true, true);
