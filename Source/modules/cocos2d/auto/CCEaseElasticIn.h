...
#ifndef __CCEaseElasticIn_h__
#define __CCEaseElasticIn_h__
...
public:
    void trace(Visitor*) {}
    static PassRefPtrWillBeRawPtr<CCEaseElasticIn> create();
    ...
    cocos2d::CCEaseElasticIn* getCocos2dImpl();
    ~CCEaseElasticIn();
public:
    CCEaseElasticIn ();
};

DEFINE_TYPE_CASTS(CCEaseElasticIn, CCEaseElastic, pCCEaseElasticIn, true, true);
