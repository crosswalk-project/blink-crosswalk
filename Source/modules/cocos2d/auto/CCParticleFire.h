...
#ifndef __CCParticleFire_h__
#define __CCParticleFire_h__
...
public:
    void trace(Visitor*) {}
    static PassRefPtrWillBeRawPtr<CCParticleFire> create();
    ...
    cocos2d::CCParticleFire* getCocos2dImpl();
    ~CCParticleFire();
public:
    CCParticleFire ();
};

DEFINE_TYPE_CASTS(CCParticleFire, CCParticleSystemQuad, pCCParticleFire, true, true);
