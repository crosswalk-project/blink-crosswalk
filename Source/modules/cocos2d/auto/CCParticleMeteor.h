...
#ifndef __CCParticleMeteor_h__
#define __CCParticleMeteor_h__
...
public:
    void trace(Visitor*) {}
    static PassRefPtrWillBeRawPtr<CCParticleMeteor> create();
    ...
    cocos2d::CCParticleMeteor* getCocos2dImpl();
    ~CCParticleMeteor();
public:
    CCParticleMeteor ();
};

DEFINE_TYPE_CASTS(CCParticleMeteor, CCParticleSystemQuad, pCCParticleMeteor, true, true);
