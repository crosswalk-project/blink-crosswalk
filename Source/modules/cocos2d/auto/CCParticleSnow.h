...
#ifndef __CCParticleSnow_h__
#define __CCParticleSnow_h__
...
public:
    void trace(Visitor*) {}
    static PassRefPtrWillBeRawPtr<CCParticleSnow> create();
    ...
    cocos2d::CCParticleSnow* getCocos2dImpl();
    ~CCParticleSnow();
public:
    CCParticleSnow ();
};

DEFINE_TYPE_CASTS(CCParticleSnow, CCParticleSystemQuad, pCCParticleSnow, true, true);
