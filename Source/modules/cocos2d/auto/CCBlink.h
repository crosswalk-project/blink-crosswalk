...
#ifndef __CCBlink_h__
#define __CCBlink_h__
...
public:
    void trace(Visitor*) {}
    static PassRefPtrWillBeRawPtr<CCBlink> create();
    ...
    cocos2d::CCBlink* getCocos2dImpl();
    ~CCBlink();
public:
    CCBlink ();
};

DEFINE_TYPE_CASTS(CCBlink, CCActionInterval, pCCBlink, true, true);
