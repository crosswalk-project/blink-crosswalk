...
#ifndef __CCRotateTo_h__
#define __CCRotateTo_h__
...
public:
    void trace(Visitor*) {}
    static PassRefPtrWillBeRawPtr<CCRotateTo> create();
    ...
    cocos2d::CCRotateTo* getCocos2dImpl();
    ~CCRotateTo();
public:
    CCRotateTo ();
};

DEFINE_TYPE_CASTS(CCRotateTo, CCActionInterval, pCCRotateTo, true, true);
