...
#ifndef __CCLiquid_h__
#define __CCLiquid_h__
...
public:
    void trace(Visitor*) {}
    static PassRefPtrWillBeRawPtr<CCLiquid> create();
    ...
    cocos2d::CCLiquid* getCocos2dImpl();
    ~CCLiquid();
public:
    CCLiquid ();
};

DEFINE_TYPE_CASTS(CCLiquid, CCGrid3DAction, pCCLiquid, true, true);
